...
genfolder = '/Users/annagoldman/Documents/Research/imgcalibration';
...
addpath(genpath([genfolder,'/code/CIRN-Quantitative-Coastal-Imaging-Toolbox-master/X_CoreFunctions']))
addpath('/Users/annagoldman/Desktop/RESEARCH/imgcalibrations/code/CIRN-Quantitative-Coastal-Imaging-Toolbox-master/X_CoreFunctions/photogrammetryFunctions')
...
odir = "/Volumes/STONE-IG-3/IG-STONE/calibration_camera2/";
%m kdir(odir)
...
iopath= '/Volumes/STONE-IG-3/IG-STONE/calibration_camera2/intrinsic_info/cam2_intrinsics_reformatted_IO.mat';
...
gcpUvdPath= "/Volumes/STONE-IG-3/IG-STONE/calibration_camera2/gcps/cam22025-08-25_15h11m11sUTC_gcp_gcpUVdInitial.mat";
...
% gcpXyzPath= [odir,'Paisley_Rock_GCPs_elevation.txt'];
gcpXyzPath= "/Volumes/STONE-IG-3/IG-STONE/calibration_camera2/gcps/GCPs_from_cloudcompare_camera_2_jess coordinate_system.csv";

%  Enter a description of the GCP World coordinate system for your own
%  records.
%ADD DATUM IF YOU CAN FIND IT!!
gcpCoord='meters';
...
% camera.
% imagePath= [genfolder,'data/Pescadero_2025Feb22/Paisley_Rock/PaisleyRock_1740233821001.tif'];
imagePath= ['/Volumes/STONE-IG-3/IG-STONE/calibration_camera2/images_12_3/imgnewcamtwo8.jpg'];
...
extrinsicsInitialGuess= [39.233376 -0.222332 2.991856 deg2rad(-180) deg2rad(0) deg2rad(90)]; % [ x y z azimuth tilt swing]
...
% Save Results
arg1 = char([odir '/' oname '_IOEOInitial']);
save(arg1,'initialCamSolutionMeta','extrinsics','intrinsics')
