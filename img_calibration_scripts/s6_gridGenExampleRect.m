...
genfolder = '/Users/annagoldman/Research/imgcalibration';
addpath(genpath([genfolder,'code/CIRN-Quantitative-Coastal-Imaging-Toolbox-master/X_CoreFunctions/']))
addpath(genpath([genfolder, 'code/CIRN-Quantitative-Coastal-Imaging-Toolbox-master/X_CoreFunctions/localTransformFunctions/']))
...
odir= '/Volumes/STONE-IG-3/IG-STONE/calibration_camera2/gridoutputs';
...
imagePath{1}= '/Volumes/STONE-IG-3/IG-STONE/calibration_camera2/images_12_3/imgnewcamtwo8.jpg';


%  Enter the filepath of the saved  IOEO calibration results produced by
%  C_singleExtrinsicSolution.
ioeopath{1}= '/Volumes/STONE-IG-3/IG-STONE/calibration_camera2/cam2_calib_IOEOInitial.mat';
...
worldCoord='meters'; %add daatum if we figure it out?  seem slike maybe just local
